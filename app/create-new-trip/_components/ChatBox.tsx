...
import { useTripDetailContext, useUserDetailContext } from "@/app/provider";
    ...
    <div className="h-[85vh] flex flex-col border rounded-2xl shadow-lg p-5">
      ...
      <section>
        <div className="border rounded-2xl p-4 shadow-xl relative">
          <Textarea
            placeholder="Let's plan your trip! Ask me anything..."
            className="w-full h-24 bg-transparent border-none focus-visible:ring-0 shadow-none resize-none"
